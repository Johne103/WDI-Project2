$(() => {
  ...
  function quizQuestion(countryCode) {
    ...
    const questions = [
      ...
      },
      {
        ...
        option3: selectedCountries[2].population.toLocaleString(),
  ...
  // function askQuestions(theQuestion, option1, option2, option3, option4, currentQuestion, countryCode) {
